...
# token = "ze3unDYXBSgE3Bdy4vjF4cl7TcfbjWOITT7qjxFxwXm"
...
# โหลดภาพ boom.jpg และให้ระบบจดจำใบหน้า
person1_image = face_recognition.load_image_file("boom.jpg")
person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

# โหลดภาพ alice.jpg และให้ระบบจดจำใบหน้า
person2_image = face_recognition.load_image_file("alice.jpg")
